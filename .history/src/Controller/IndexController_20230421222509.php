...
class IndexController extends AbstractController
{
    ...
    public function index(EPaginatorInterface $paginator ,Request $request,FrontManager $front_manager, ParameterBagInterface $params ): Response
    {
        
        $token = $_COOKIE['jwt_token'];
        $base_url = $params->get('app_baseurl');
         
        $client_planta = new Client(['base_uri' => $base_url]);
        ...
        $client_herbolario=new Client(['base_uri' => $base_url]);
