...
class IndexController extends AbstractController
{
    ...
    public function index(PaginatorInterface $paginator ,Request $request,FrontManager $front_manager, ParameterBagInterface $params ): Response
    {
        ...
        $plantas_response= $front_manager->petition('GET',$options,$relative_url); 
        $herbolarios_response= $front_manager->petition('GET',$options,$relative_url); 
