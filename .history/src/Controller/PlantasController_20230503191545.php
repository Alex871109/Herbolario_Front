...
class PlantasController extends AbstractController
{
    ...
    public function nueva(Request $request,FrontManager $frontManager): Response
    {
        ...
        $options_find=['headers' => ['Authorization' => 'Bearer '.$token, 'Accept'        => 'application/json'],'json' => ['nombre' => $nombre, 'url'=>$url]];
        // $planta=new Planta();
        ...
        if($request->getMethod()==='POST'){
            ...
            $planta_find_response=$frontManager->petition('GET',,$planta_find_relative_url);
