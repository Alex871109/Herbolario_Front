...
class PlantasController extends AbstractController
{
    ...
    public function nueva(Request $request,FrontManager $frontManager): Response
    {
        if(isset($_COOKIE['jwt_token'])){
            ...
            $herbolario_array = [];
            $infocomercial_array = [];
            $usos_relative_url='api/usus/index';
            $herbolario_relative_url='api/herbolario/index';
            ...
            $usos_index_options=['headers' => ['Authorization' => 'Bearer '.$token, 'Accept'        => 'application/json'],]; 
            ...
            $herbolario_index_options=['headers' => ['Authorization' => 'Bearer '.$token, 'Accept'        => 'application/json'],]; 
            $herbolario_index_relativeurl='api/usos/index';
            $herbolarios=$frontManager->petition('GET',$herbolario_index_options,$usos_index_relativeurl);
