...
class PlantasController extends AbstractController
{
    ...
    public function nueva(Request $request,FrontManager $frontManager): Response
    {
        ...
        if(isset($_COOKIE['jwt_token'])){
            ...
            // Obtener la lista de usos y herbolarios de la API
            ...
            $herbolarios=json_decode($herbolarios_response->getBody()->getContents(),true);
             // Verificar si se recibió una solicitud POST (es decir, si se envió un formulario de creación de planta)
            if($request->getMethod()==='POST'){
                ...
                // Buscar la planta por nombre en la API para verificar si ya está registrada
